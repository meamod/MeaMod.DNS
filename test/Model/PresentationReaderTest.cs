...
namespace MeaMod.DNS.Model
{
    ...
    public class PresentationReaderTest
    {
        ...
        public void ReadResource()
        {
            ...
            Assert.AreEqual(ResourceRecord.DefaultHostTTL, resource.TTL);
...
";
            ...
            Assert.AreEqual(ResourceRecord.DefaultHostTTL, a.TTL);
            ...
            Assert.AreEqual(ResourceRecord.DefaultHostTTL, aaaa.TTL);
