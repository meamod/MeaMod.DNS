...
//#endif
                    ...
                    Debug.WriteLine($"Will send via {localEndpoint}");
                ...
                {
                    Debug.WriteLine($"Cannot setup send socket for {address}: {e.Message}");
                    sender.Dispose();
                }
            }
        ...
        public async Task SendAsync(byte[] message)
        {
            foreach (var sender in senders)
            {
                ...
                {
                    Debug.WriteLine($"Sender {sender.Key} failure: {e.Message}");
                    // eat it.
                }
            }
        }
